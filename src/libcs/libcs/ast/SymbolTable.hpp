...
public:
    Symbol ( TableType table_typ, std::string obj_name, std::string var_typ, std::size_t scope_level)
    : table_type_(table_typ), obj_name_(obj_name), var_type_(var_typ), scope_level_(scope_level) {}
