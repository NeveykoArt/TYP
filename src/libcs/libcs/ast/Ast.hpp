...
class Expression final : public Node {
 ...
 public:
  explicit Expression(std::vector<Expressions*> expressions)
...
class Mas_selection final : public Node {
 ...
 public:
  explicit Mas_selection(
      std::string var_type_tmp,
      Length* length,
      std::vector<Literal*> literal)
      : var_type_(std::move(var_type_tmp)),
...
class Length final : public Node {
 ...
 public:
  explicit Length(std::string id_number) : id_number_(std::move(id_number)) {}
...
class Mas_statement final : public Node {
 ...
 public:
  ...
  explicit Mas_statement(
      Mas_change* mas_change,
      std::vector<Arg*> arg_rigth,
      std::string bin_op)
      : mas_change_(std::move(mas_change)),
        arg_rigth_(std::move(arg_rigth)),
        bin_op_(std::move(bin_op)) {}
...
class Scope final : public Node {
 ...
 public:
  explicit Scope(std::vector<Statement*> statements)
...
class Return_statement final : public Node {
 ...
 public:
  explicit Return_statement(Arg* arg) : arg_(arg) {}
  explicit Return_statement(Func_call* func_call) : func_call_(func_call) {}
...
class Func_def final : public Node {
 ...
 public:
  explicit Func_def(
      ...
      Pars* pars,
      Scope* scope,
      Return_statement* return_tmp)
      : void_(std::move(void_tmp)),
...
class Assign_statement final : public Node {
 ...
 public:
  ...
  explicit Assign_statement(
      std::string id_left,
      std::vector<Arg*> arg_rigth,
      std::string bin_op)
      : id_left_(std::move(id_left)),
        arg_rigth_(std::move(arg_rigth)),
        bin_op_(std::move(bin_op)) {}
...
class For_operation final : public Node {
 ...
 public:
  explicit For_operation(std::string id_var, std::string unar_op)
      : id_var_(std::move(id_var)), unar_op_(std::move(unar_op)) {}
...
class If_statement final : public Node {
 ...
 public:
  explicit If_statement(std::string arg1, Scope* scope)
      : arg1_(std::move(arg1)), scope_(scope) {}
  explicit If_statement(
      std::string arg1,
      std::string logic_op,
      Arg* arg2,
      Scope* scope)
      : arg1_(std::move(arg1)),
        logic_op_(std::move(logic_op)),
        arg2_(arg2),
        scope_(scope) {}
  explicit If_statement(
      std::string arg1,
      Scope* scope,
      Else_statement* else_tmp)
      : arg1_(std::move(arg1)), scope_(scope), else_(else_tmp) {}
  explicit If_statement(
      std::string arg1,
      std::string logic_op,
      Arg* arg2,
...
class Else_statement final : public Node {
 ...
 public:
  explicit Else_statement(Scope* scope) : scope_(scope) {}
...
class Read_statement final : public Node {
 ...
 public:
  explicit Read_statement(Arg* arg) : arg_(arg) {}
...
class Print_statement final : public Node {
 ...
 public:
  explicit Print_statement(Arg* arg) : arg_(arg) {}
