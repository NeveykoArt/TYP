...
std::any Builder::visitClass(CSharpParser::ClassContext* context) {
  auto* value = dynamic_cast<Expression*>(
      std::any_cast<Node*>(visit(context->expression())));
...
std::any Builder::visitExpression(CSharpParser::ExpressionContext* context) {
  ...
  if (!context->expressions().empty()) {
    for (auto* el : context->expressions()) {
      exprs.push_back(
          dynamic_cast<Expressions*>(std::any_cast<Node*>(visit(el))));
    }
...
std::any Builder::visitMas_statement(
    CSharpParser::Mas_statementContext* context) {
  if (context->mas_def() != nullptr) {
    ...
    if (context->func_call() != nullptr) {
      ...
      return static_cast<Node*>(program_.create_node<Mas_statement>(
          m_d, exprs, context->BINARY_OP()->getText()));
    } else if (context->mas_selection() != nullptr) {
      auto* m_s = dynamic_cast<Mas_selection*>(
          std::any_cast<Node*>(visit(context->mas_selection())));
      ...
      return static_cast<Node*>(
          program_.create_node<Mas_statement>(m_d, exprs));
    }
  } else {
    auto* m_c = dynamic_cast<Mas_change*>(
    ...
    if (context->func_call() != nullptr) {
      ...
      return static_cast<Node*>(program_.create_node<Mas_statement>(
          m_c, exprs, context->BINARY_OP()->getText()));
    } else {
      std::vector<Arg*> exprs;
      for (auto* el : context->arg()) {
        exprs.push_back(dynamic_cast<Arg*>(std::any_cast<Node*>(visit(el))));
      ...
      return static_cast<Node*>(
          program_.create_node<Mas_statement>(m_c, exprs));
    }
  }
  return 0;
}

std::any Builder::visitAssign_statement(
    CSharpParser::Assign_statementContext* context) {
  if (context->var_def() != nullptr) {
    ...
    if (context->func_call() != nullptr) {
      auto* f_c = dynamic_cast<Func_call*>(
          std::any_cast<Node*>(visit(context->func_call())));
      return static_cast<Node*>(
          program_.create_node<Assign_statement>(v_d, f_c));
    } else if (context->BINARY_OP() != nullptr) {
      std::vector<Arg*> exprs;
      for (auto* el : context->arg()) {
        exprs.push_back(dynamic_cast<Arg*>(std::any_cast<Node*>(visit(el))));
      }
      return static_cast<Node*>(program_.create_node<Assign_statement>(
          v_d, exprs, context->BINARY_OP()->getText()));
    } else if (context->mas_selection() != nullptr) {
      auto* m_c = dynamic_cast<Mas_selection*>(
          std::any_cast<Node*>(visit(context->mas_selection())));
      return static_cast<Node*>(
          program_.create_node<Assign_statement>(v_d, m_c));
    } else {
      std::vector<Arg*> exprs;
      for (auto* el : context->arg()) {
        exprs.push_back(dynamic_cast<Arg*>(std::any_cast<Node*>(visit(el))));
      ...
      return static_cast<Node*>(
          program_.create_node<Assign_statement>(v_d, exprs));
    }
  } else {
    ...
    if (context->func_call() != nullptr) {
      auto* f_c = dynamic_cast<Func_call*>(
          std::any_cast<Node*>(visit(context->func_call())));
      return static_cast<Node*>(
          program_.create_node<Assign_statement>(id_left, f_c));
    } else if (context->BINARY_OP() != nullptr) {
      std::vector<Arg*> exprs;
      for (auto* el : context->arg()) {
        exprs.push_back(dynamic_cast<Arg*>(std::any_cast<Node*>(visit(el))));
      ...
      return static_cast<Node*>(program_.create_node<Assign_statement>(
          id_left, exprs, context->BINARY_OP()->getText()));
    } else if (context->mas_selection() != nullptr) {
      auto* m_c = dynamic_cast<Mas_selection*>(
          std::any_cast<Node*>(visit(context->mas_selection())));
      return static_cast<Node*>(
          program_.create_node<Assign_statement>(id_left, m_c));
    } else {
      std::vector<Arg*> exprs;
      for (auto* el : context->arg()) {
        exprs.push_back(dynamic_cast<Arg*>(std::any_cast<Node*>(visit(el))));
      ...
      return static_cast<Node*>(
          program_.create_node<Assign_statement>(id_left, exprs));
    }
  }
  return 0;
}
...
std::any Builder::visitLiteral(CSharpParser::LiteralContext* context) {
  ...
  if (context->TEXT() != nullptr) {
    return static_cast<Node*>(program_.create_node<Literal>(
        normalize_register(context->getText()), "string"));
  }
  if (context->NUMBER() != nullptr) {
    return static_cast<Node*>(program_.create_node<Literal>(
        normalize_register(context->getText()), "int"));
  }
  if (context->CHARv() != nullptr) {
    return static_cast<Node*>(program_.create_node<Literal>(
        normalize_register(context->getText()), "char"));
  }
  if (context->FLOAT_NUMBER() != nullptr) {
    return static_cast<Node*>(program_.create_node<Literal>(
        normalize_register(context->getText()), "float"));
  }
  return static_cast<Node*>(program_.create_node<Literal>(
...
std::any Builder::visitMas_change(CSharpParser::Mas_changeContext* context) {
  ...
  if (context->length() != nullptr) {
    leng =
        dynamic_cast<Length*>(std::any_cast<Node*>(visit(context->length())));
  }
  return static_cast<Node*>(
      program_.create_node<Mas_change>(context->ID()->getText(), leng));
}

std::any Builder::visitMas_selection(
    CSharpParser::Mas_selectionContext* context) {
  ...
  return static_cast<Node*>(program_.create_node<Mas_selection>(
      context->VAR()->getText(), leng, lits));
}

std::any Builder::visitLength(CSharpParser::LengthContext* context) {
  return static_cast<Node*>(
      program_.create_node<Length>(normalize_register(context->getText())));
}

std::any Builder::visitMas_def(CSharpParser::Mas_defContext* context) {
  return static_cast<Node*>(program_.create_node<Mas_def>(
      context->VAR()->getText(), context->ID()->getText()));
}

std::any Builder::visitVar_def(CSharpParser::Var_defContext* context) {
  return static_cast<Node*>(program_.create_node<Var_def>(
      context->VAR()->getText(), context->ID()->getText()));
}

std::any Builder::visitFunc_def(CSharpParser::Func_defContext* context) {
  Pars* pars = nullptr;
  if (context->pars() != nullptr) {
    pars = dynamic_cast<Pars*>(std::any_cast<Node*>(visit(context->pars())));
  }
  auto* scope =
  ...
  if (context->VOID() != nullptr) {
    ...
    if (!context->KEYWORD().empty()) {
      ...
      return static_cast<Node*>(program_.create_node<Func_def>(
          keywords, void_tmp, func_name, pars, scope, return_tmp));
    }
    return static_cast<Node*>(program_.create_node<Func_def>(
        void_tmp, func_name, pars, scope, return_tmp));
  } else {
    ...
    if (!context->KEYWORD().empty()) {
      ...
      return static_cast<Node*>(program_.create_node<Func_def>(
          keywords, var, func_name, pars, scope, return_tmp));
    }
    return static_cast<Node*>(program_.create_node<Func_def>(
        var, func_name, pars, scope, return_tmp));
  }
  return 0;
}
...
std::any Builder::visitReturn_statement(
    CSharpParser::Return_statementContext* context) {
  if (context->arg() != nullptr) {
    auto* arg = dynamic_cast<Arg*>(std::any_cast<Node*>(visit(context->arg())));
    return static_cast<Node*>(program_.create_node<Return_statement>(arg));
  }
  if (context->func_call() != nullptr) {
    auto* f_c = dynamic_cast<Func_call*>(
        std::any_cast<Node*>(visit(context->func_call())));
    return static_cast<Node*>(program_.create_node<Return_statement>(f_c));
  }
  Arg* arg = nullptr;
  return static_cast<Node*>(program_.create_node<Return_statement>(arg));
}
...
std::any Builder::visitStatement(CSharpParser::StatementContext* context) {
  ...
  if (context->if_statement() != nullptr) {
    auto* i_s = dynamic_cast<If_statement*>(
        std::any_cast<Node*>(visit(context->if_statement())));
  ...
  if (context->read_statement() != nullptr) {
    auto* r_s = dynamic_cast<Read_statement*>(
        std::any_cast<Node*>(visit(context->read_statement())));
    return static_cast<Node*>(program_.create_node<Statement>(r_s));
  }
  if (context->print_statement() != nullptr) {
    auto* p_s = dynamic_cast<Print_statement*>(
        std::any_cast<Node*>(visit(context->print_statement())));
    return static_cast<Node*>(program_.create_node<Statement>(p_s));
  }
  if (context->return_statement() != nullptr) {
    auto* return_tmp = dynamic_cast<Return_statement*>(
        std::any_cast<Node*>(visit(context->return_statement())));
    return static_cast<Node*>(program_.create_node<Statement>(return_tmp));
  }
  return 0;
}
...
std::any Builder::visitFunc_call(CSharpParser::Func_callContext* context) {
  auto* value =
      dynamic_cast<Arguments*>(std::any_cast<Node*>(visit(context->args())));
  return static_cast<Node*>(
      program_.create_node<Func_call>(context->ID()->getText(), value));
}
...
std::any Builder::visitArg(CSharpParser::ArgContext* context) {
  if (context->literal() != nullptr) {
    auto* l =
        dynamic_cast<Literal*>(std::any_cast<Node*>(visit(context->literal())));
  ...
  if (!context->var_def().empty()) {
    ...
    if (!context->mas_def().empty()) {
      ...
      for (auto* el : context->mas_def()) {
        exprs2.push_back(
            dynamic_cast<Mas_def*>(std::any_cast<Node*>(visit(el))));
      }
...
std::any Builder::visitIf_statement(
    CSharpParser::If_statementContext* context) {
  ...
  if (context->arg() != nullptr) {
    auto* arg2 =
        dynamic_cast<Arg*>(std::any_cast<Node*>(visit(context->arg())));
    ...
    if (context->else_statement() != nullptr) {
      ...
      return static_cast<Node*>(program_.create_node<If_statement>(
          arg1, logop, arg2, scope, else_st));
    }
    return static_cast<Node*>(
        program_.create_node<If_statement>(arg1, logop, arg2, scope));
  }
  ...
  if (context->else_statement() != nullptr) {
    auto* else_st = dynamic_cast<Else_statement*>(
        std::any_cast<Node*>(visit(context->else_statement())));
    return static_cast<Node*>(
        program_.create_node<If_statement>(arg1, scope, else_st));
  }
  return static_cast<Node*>(program_.create_node<If_statement>(arg1, scope));
}

std::any Builder::visitElse_statement(
    CSharpParser::Else_statementContext* context) {
  auto* arg =
      dynamic_cast<Scope*>(std::any_cast<Node*>(visit(context->scope())));
  return static_cast<Node*>(program_.create_node<Else_statement>(arg));
}

std::any Builder::visitFor_statement(
    CSharpParser::For_statementContext* context) {
  ...
  auto* scope =
      dynamic_cast<Scope*>(std::any_cast<Node*>(visit(context->scope())));
  return static_cast<Node*>(
      program_.create_node<For_statement>(assign, cond, oper, scope));
}

std::any Builder::visitFor_condition(
    CSharpParser::For_conditionContext* context) {
  auto arg1 = context->ID()->getText();
  auto logop = normalize_register(context->LOGIC_OP()->getText());
  auto* arg2 = dynamic_cast<Arg*>(std::any_cast<Node*>(visit(context->arg())));
  return static_cast<Node*>(
      program_.create_node<For_condition>(arg1, logop, arg2));
}

std::any Builder::visitFor_operation(
    CSharpParser::For_operationContext* context) {
  if (context->assign_statement() != nullptr) {
    ...
    return static_cast<Node*>(
        program_.create_node<For_operation>(id_var, unarop));
  }
  return 0;
}

std::any Builder::visitKw_statement(
    CSharpParser::Kw_statementContext* context) {
  return static_cast<Node*>(program_.create_node<Kw_statement>(
      normalize_register(context->getText())));
}

std::any Builder::visitPrint_statement(
    CSharpParser::Print_statementContext* context) {
  auto* id = dynamic_cast<Arg*>(std::any_cast<Node*>(visit(context->arg())));
  return static_cast<Node*>(program_.create_node<Print_statement>(id));
}

std::any Builder::visitRead_statement(
    CSharpParser::Read_statementContext* context) {
  auto* id = dynamic_cast<Arg*>(std::any_cast<Node*>(visit(context->arg())));
