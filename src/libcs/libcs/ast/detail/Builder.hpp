...
class Builder final : public CSharpBaseVisitor {
 public:
  ...
  antlrcpp::Any visitExpression(
      CSharpParser::ExpressionContext* context) override;
  antlrcpp::Any visitExpressions(
      CSharpParser::ExpressionsContext* context) override;
  antlrcpp::Any visitMas_statement(
      CSharpParser::Mas_statementContext* context) override;
  ...
  antlrcpp::Any visitMas_change(
      CSharpParser::Mas_changeContext* context) override;
  antlrcpp::Any visitMas_selection(
      CSharpParser::Mas_selectionContext* context) override;
  ...
  antlrcpp::Any visitStatement(
      CSharpParser::StatementContext* context) override;
  antlrcpp::Any visitFunc_call(
      CSharpParser::Func_callContext* context) override;
  ...
  antlrcpp::Any visitIf_statement(
      CSharpParser::If_statementContext* context) override;
  antlrcpp::Any visitElse_statement(
      CSharpParser::Else_statementContext* context) override;
  antlrcpp::Any visitFor_statement(
      CSharpParser::For_statementContext* context) override;
  antlrcpp::Any visitFor_condition(
      CSharpParser::For_conditionContext* context) override;
  antlrcpp::Any visitFor_operation(
      CSharpParser::For_operationContext* context) override;
  antlrcpp::Any visitKw_statement(
      CSharpParser::Kw_statementContext* context) override;
  antlrcpp::Any visitPrint_statement(
      CSharpParser::Print_statementContext* context) override;
  antlrcpp::Any visitRead_statement(
      CSharpParser::Read_statementContext* context) override;
